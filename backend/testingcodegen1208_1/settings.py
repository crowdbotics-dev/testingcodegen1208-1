"""
Django settings for testingcodegen1208_1 project.
...
ROOT_URLCONF = 'testingcodegen1208_1.urls'
...
WSGI_APPLICATION = 'testingcodegen1208_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testingcodegen1208_1 API",
    "DESCRIPTION": "API documentation for testingcodegen1208_1 App",
    "VERSION": "v1",
}
